...
public abstract class Descriptor {
    public static class Tag {
        ...
        public static final short VER_2 = 2;
        public static final short VER_3 = 3;

        public static final byte RESERVED = 0;

        public static final short SERIAL_NONE = 0;
        public static final short SERIAL_ONE  = 1;

        public static final short CRC_NONE = 0;
        public static final short CRC_LENGTH_NONE = 0;
