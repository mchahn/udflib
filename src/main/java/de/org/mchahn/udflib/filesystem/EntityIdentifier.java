...
public class EntityIdentifier {   // aka regid
    ...
    public static final int FLAG_PROTECTED = 2;
    ...
    public abstract static class RevisionSuffix extends Suffix {
        public static final short UDF_REVISION_102 = 0x0102;
    ...
    public static class OSTASuffix extends RevisionSuffix {
        public static final int DOMAINFLAG_HARD_WRITE_PROTECT = 1;
        public static final int DOMAINFLAG_SOFT_WRITE_PROTECT = 2;

        public byte    domainFlags;
        public BytePtr reserved;

        public static final int RESV_LEN = 5;

        public OSTASuffix() {
        }
        protected OSTASuffix(BytePtr data) {
            int ofs = super.parse(data);
    ...
    public interface OSInfo {
        public static final byte OSCLASS_UNDEFINED = 0;
        public static final byte OSCLASS_DOS       = 1;
        public static final byte OSCLASS_OS2       = 2;
        public static final byte OSCLASS_MAC       = 3;
        public static final byte OSCLASS_UNIX      = 4;

        public static final byte OSID_DOS             = 0;
        public static final byte OSID_OS2             = 0;
        public static final byte OSID_UNIX_MACOS      = 0;
        public static final byte OSID_UNIX_GENERIC    = 0;
        public static final byte OSID_UNIX_IBMAIX     = 1;
        public static final byte OSID_UNIX_SUNSOLARIS = 2;
        public static final byte OSID_UNIX_HPUX       = 3;
        public static final byte OSID_UNIX_IRIX       = 4;
    }

    public static class UDFSuffix extends RevisionSuffix implements OSInfo {
        public static final int RESV_LEN = 4;
    ...
    public static class ImplSuffix extends Suffix implements OSInfo {
        public static final int IMPL_USE_AREA_LEN = 6;
