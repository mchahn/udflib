...
public class PrimaryVolumeDescriptor extends Descriptor {
    public static final int IMPL_USE_LEN = 64;
    public static final int RESV_LEN     = 22;

    public static final int FLAG_VSI_COMMON = 1;
    ...
    public static final int VOL_ID_LEN = 32;

    static final int VOL_SET_ID_LEN = 128;
