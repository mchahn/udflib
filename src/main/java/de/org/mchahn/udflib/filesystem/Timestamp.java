...
public class Timestamp {
    ...
    // time zones...
    public static final int COORDINATED_UNIVERSAL_TIME = 0;
    public static final int LOCAL_TIME = 1;
    public static final int CUSTOM_TIME = 2;

    public static final int NO_OFFSET = -2047;
    ...
    static final int int12ToInt32(int v) {
        v &= 0x0fff;
    ...
    static final TimeZone TZ_LOC = TimeZone.getDefault();
