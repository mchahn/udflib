...
public class FileSetDescriptor extends Descriptor {
    ...
    public static final int LOG_VOL_ID_LEN  = 128;
    public static final int FILE_SET_ID_LEN = 32;
    public static final int CR_FILE_ID_LEN  = 32;
    public static final int ABS_FILE_ID_LEN = 32;
    public static final int RSV_LEN         = 48 - AllocationDescriptor.Long.LENGTH;
