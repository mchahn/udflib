...
public abstract class AllocationDescriptor {
    ...
    public static final int maxLength(final int blockSize) {
    ...
    public static class Short extends AllocationDescriptor { // aka short_ad
        ...
        public static final AllocationDescriptor.Short ZERO;
        static {
    ...
    public static class Long extends AllocationDescriptor { // aka long_ad
        ...
        public static final int IMPL_USE_LEN = 6;

        public static final AllocationDescriptor.Long ZERO;
        static {
