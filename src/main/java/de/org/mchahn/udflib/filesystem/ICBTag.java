...
public class ICBTag {
    ...
    public static final short STRATEGY_NO          = 0;
    public static final short STRATEGY_UDF102      = 4;
    public static final short STRATEGY_UDF102_WORM = 4096;

    public static final BytePtr SPARAMS_ZERO = new BytePtr(new byte[2]);
    ...
    public static final int FLAG_DIRSORT     = 8;
    public static final int FLAG_NONRELOC    = 16;
    public static final int FLAG_ARCHIVE     = 32;
    public static final int FLAG_SETUID      = 64;
    public static final int FLAG_SETGID      = 128;
    public static final int FLAG_STICKY      = 256;
    public static final int FLAG_CONTIGUOUS  = 512;
    public static final int FLAG_SYSTEM      = 1024;
    public static final int FLAG_TRANSFORMED = 2048;
    public static final int FLAG_MULTIVER    = 4096;
    public static final int FLAG_STREAM      = 16384;
    ...
    public static final int STRAT_PARAM_LEN = 2;
    ...
    public static final int ALLOCDESC_SHORT    = 0;
    public static final int ALLOCDESC_LONG     = 1;
    public static final int ALLOCDESC_EXTENDED = 2;
    public static final int ALLOCDESC_EMBEDDED = 3;
