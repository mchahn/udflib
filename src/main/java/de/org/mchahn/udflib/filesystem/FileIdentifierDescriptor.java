...
public class FileIdentifierDescriptor extends Descriptor implements UDF {
    public static final int FCBIT_EXISTENCE = 1;
    public static final int FCBIT_DIRECTORY = 2;
    public static final int FCBIT_DELETED   = 4;
    public static final int FCBIT_PARENT    = 8;
    public static final int FCBIT_METADATA  = 16;
    ...
    public static final int pad(int sz) {
        sz += 38;
        return ((sz + 3 >> 2) << 2) - sz;
    }
