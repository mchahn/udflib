...
import de.org.mchahn.udflib.filesystem.CRC_CCITT;
import de.org.mchahn.udflib.filesystem.Descriptor;
import de.org.mchahn.udflib.filesystem.EntityIdentifier;
import de.org.mchahn.udflib.filesystem.ExtendedAttribute;
import de.org.mchahn.udflib.filesystem.ExtendedAttributeHeaderDescriptor;
...
public class UDFBrowser implements UDF {
    static final Log _log = new Log("udf.browser");
    ...
    public interface Listener {
        public static final char PATH_SEPA = '/';
    ...
    public UDFBrowser(File image, Listener listener) throws IOException {
    ...
    public UDFBrowser(BlockDevice bdev, Listener listener) {
        init(bdev, listener);
    }

    protected UDFBrowser() {
    }
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (1 > args.length || args.length > 2) {
            System.err.printf("usage: %s [imagefile] {sectorsize}", UDFBrowser.class.getName());
            return;
        }
        ...
        try {
            new UDFBrowser(new File(args[0]), new DefaultListener()).exec();
        }
        catch (Throwable err) {
